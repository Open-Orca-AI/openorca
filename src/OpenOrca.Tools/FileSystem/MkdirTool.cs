...
public sealed class MkdirTool : IOrcaTool
{
    public string Name => "mkdir";
    public string Description => "Create a directory and any missing parent directories. Succeeds silently if it already exists. Use this before write_file if unsure whether the parent directory exists.";
